...
<html lang="en">
<head>
<title>Designa Studio | Contact</title>
<meta charset="UTF-8">
...
<header class="center clearfix" id="navtop"> <a href="index.jsp" class="logo fleft"><img src="img/logo.png" alt="" /></a>
  <nav class="fright">
    ...
    <ul>
      ...
      <li><a href="contact.jsp" class="navactive">Contact</a></li>
    </ul>
  </nav>
</header>
<div class="contact center part clearfix">
  ...
  <aside class="column4 mright">
    ...
    <span class="strong">DESIGNA studio</span> <br >
    3615 Fake Street <br >
    Level 5, Door 123 <br >
    1010 WHATEVER
    </address>
    <p class="mbottom">00 77 66 55 33<br >
      00 77 66 55 33</p>
    <p class="mbottom"> <a href="#">adresse@email.com</a><br >
      <a href="#">Designa Studio on Facebook</a><br >
      <a href="#">@designa on Twitter</a><br >
  ...
  <section class="columnthird content">
    ...
    <p class="more">Don't forget to put your own email address in the php file !</p>
